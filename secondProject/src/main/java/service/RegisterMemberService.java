...
public class RegisterMemberService {
	...
	public Long join(String email, String password, String name, String role, String provider

	) {

		Member member = Member.createMember(email, password, name,passwordEncoder);
